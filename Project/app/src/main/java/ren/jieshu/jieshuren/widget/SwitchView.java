package ren.jieshu.jieshuren.widget;
...
public class SwitchView extends View {
    private final int DEFAULT_COLOR_PRIMARY = 0xFFE7554D;
    private final int DEFAULT_COLOR_PRIMARY_DARK = 0xFFCCCCCC;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setColor(isOn ? colorPrimary : colorPrimaryDark);
